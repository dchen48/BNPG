...
def get_config():
    ...
    parser.add_argument("--seed", type=int, default=5, help="Random seed for numpy/torch")
    ...
    # save parameters
    parser.add_argument("--save_interval", type=int, default=25, help="time duration between contiunous twice models saving.")
    ...
    # graph net parameters
    #parser.add_argument("--n_agents", type=int, default=4)
    #parser.add_argument("--n_actions", type=int, default=5)
    parser.add_argument("--edge_net_type", type=str, default='deep_set', help="specify the type of permutation matrix generator") #deep_set, set_transformer

    parser.add_argument("--graph_type", type=str, default='dynamic', help="specify the type of permutation matrix generator") #dynamic, random, none, fully_connected
    parser.add_argument("--threshold", type=float, default=1, help="specify the type of permutation matrix generator") #dynamic, dummy
    
    parser.add_argument("--fixed_father_action", action='store_true', default=False, help="flag for fixed father action or not")
