...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        #print('obs_agent_id: ',obs_agent_id)
        #print('state_agent_id: ',state_agent_id)
        #print('obs_last_action: ',obs_last_action)
        #print('state_last_action: ',state_last_action)
        #print('obs_instead_of_state: ',obs_instead_of_state)
        #print('use_state_agent: ',args.use_state_agent)
        #print('add_local_obs: ',args.add_local_obs)
        #print('add_agent_id: ',args.add_agent_id)
    ...
    def get_obs_agent(self, agent_id):
        ...
        #print('self.obs_all_health: ',self.obs_all_health)
        #print('self.shield_bits_ally: ',self.shield_bits_ally)
        #print('self.unit_type_bits: ',self.unit_type_bits)
        #print('ally_feats: ',ally_feats.shape)
        #print('enemy_feats: ',enemy_feats.shape)
        #print('move_feats: ',move_feats.shape)
        #print('own_feats: ',own_feats.shape)
        #print('self.obs_timestep_number: ',self.obs_timestep_number)
