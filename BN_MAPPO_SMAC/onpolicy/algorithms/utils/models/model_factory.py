...
MODEL_MAP = {
    ...
    'gcn_actor_mean': functools.partial(graph_net.GraphActorNet, pool_type='avg'),
    'gcn_actor_max': functools.partial(graph_net.GraphActorNet, pool_type='max'),
